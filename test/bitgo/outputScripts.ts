...
describe('createOutputScript2of3()', function () {
  ...
  scriptTypes2Of3.forEach(scriptType => {
    it(`creates output script (type=${scriptType})`, function () {
      ...
      const p2wsh =
        '002095ecaacb606b9ece3821c0111c0a1208dd1d35192809bf8cf6cbad4bbeaca67f'

      const {scriptPubKey, redeemScript, witnessScript} =
        createOutputScript2of3(
      ...
      switch (scriptType) {
        case 'p2sh':
          assert.strictEqual(
            ...
            'a91491590bed8198ea7ca57ba68ab7cbfabc656cbbaf87',
          )
        ...
        case 'p2shP2wsh':
          assert.strictEqual(
            scriptPubKey.toString('hex'),
            'a9140312dd6f801ab11d53c35f6a2bdac9c602a55d9d87',
          )
          assert.strictEqual(
