...
describe('bitcoinjs-lib (crypto)', function () {
  it('can recover a private key from duplicate R values', function () {
    ...
    var tx = bitcoin.Transaction.fromHex(
      '',
    )
    ...
    tx.ins.forEach(function (input, vin) {
      ...
      assert(
        bitcoin.script.pubKeyHash.input.check(scriptChunks),
        'Expected pubKeyHash script',
      )
      var prevOutScript = bitcoin.address.toOutputScript(
        '1ArJ9vRaQcoQ29mTWZH768AmRwzb6Zif1z',
      )
      var scriptSignature = bitcoin.ECSignature.parseScriptSignature(
        scriptChunks[0],
      )
    ...
    for (var i = 0; i < tx.ins.length; ++i) {
      for (var j = i + 1; j < tx.ins.length; ++j) {
        ...
        assert.strictEqual(
          inputA.signature.r.toString(),
          inputB.signature.r.toString(),
        )
  ...
  it('can recover a BIP32 parent private key from the parent public key, and a derived, non-hardened child private key', function () {
    function recoverParent(master, child) {
      ...
      for (var i = 0; i < bitcoin.HDNode.HIGHEST_BIT; ++i) {
        ...
        // calculate I
        var I = crypto
          .createHmac('sha512', master.chainCode)
          .update(data)
          .digest()
        var IL = I.slice(0, 32)
      ...
      var node = new bitcoin.HDNode(
        new bitcoin.ECPair(d2),
        master.chainCode,
        master.network,
      )
