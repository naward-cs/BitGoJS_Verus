...
describe('bitcoinjs-lib (crypto)', function () {
  it('can generate a single-key stealth address', function () {
    ...
    var recipient = bitcoin.ECPair.fromWIF(
      '5KYZdUEo39z3FPrtuX2QbbwGnNP5zTd7yyr2SC1j299sBCnWjss',
    ) // private to recipient
    var nonce = bitcoin.ECPair.fromWIF(
      'KxVqB96pxbw1pokzQrZkQbLfVBjjHFfp2mFfEp8wuEyGenLFJhM9',
    ) // private to sender
    ...
    assert.equal(
      forRecipient.getAddress(),
      '1CcZWwCpACJL3AxqoDbwEt4JgDFuTHUspE',
    )
    assert.equal(
      forRecipient.toWIF(),
      'L1yjUN3oYyCXV3LcsBrmxCNTa62bZKWCybxVJMvqjMmmfDE8yk7n',
    )
  ...
  it('can generate a dual-key stealth address', function () {
    ...
    var scan = bitcoin.ECPair.fromWIF(
      'L5DkCk3xLLoGKncqKsWQTdaPSR4V8gzc14WVghysQGkdryRudjBM',
    ) // private to scanner/recipient
    var nonce = bitcoin.ECPair.fromWIF(
      'KxVqB96pxbw1pokzQrZkQbLfVBjjHFfp2mFfEp8wuEyGenLFJhM9',
    ) // private to sender
